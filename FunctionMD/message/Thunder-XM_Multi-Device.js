...
} else if ((isMedia && m.message.videoMessage.seconds < 11 || m.isQuotedVideo && m.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.seconds < 11)) {
encmedia = m.isQuotedVideo ? m.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage : m.message.videoMessage
let rane = getRandom('.'+ await getExtension(encmedia.mimetype))
let imgbuff = await getFileBuffer(encmedia, 'video')
fs.writeFileSync(rane, imgbuff)
...
const sections = [
	   ...
	   },	
	{
	   ...
	   {
	    title: "🐔️𝐺𝐴𝐿𝐼𝑁𝐻𝐴 10🐔️", 
	    rowId: ".jual galinha 10"
	   },	
	   {
	    title: "🐇️𝐶𝑂𝐸𝐿𝐻𝑂 10🐇️", 
	    rowId: ".jual coelho 10"
	   },	
	   {
	    title: "🐑️𝑂𝑉𝐸𝐿𝐻𝐴 10🐑️", 
	    rowId: ".jual ovelha 10"
	   },	
	   {
	    title: "🗡️𝐹𝐸𝑅𝑅𝑂 10🗡️️", 
	    rowId: ".jual ferro 10"
	   ...
	   {
	    title: "💰️𝐸𝑆𝑀𝐸𝑅𝐴𝐿𝐷𝐴 10💰️", 
	    rowId: ".jual esmeralda 10"
	   },	
   ]
    }    
    ]
